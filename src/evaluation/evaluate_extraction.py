...
Compares extracted field values against ground truth for twelve core fields:
- project_address
- contractor_name
- jurisdiction
- system_size_kw
    ...
    for field_name in target_fields:
        ...
        if field_name == "system_size_kw":
            ...
            if isinstance(expected_norm, (int, float)) and isinstance(actual_norm, (int, float)):
                ...
                exact_match = False
        elif field_name in ("module_count", "main_bus_amp_rating", "main_breaker_amp_rating", "utility_service_rating", "grid_voltage"):
